...
import com.video.tamas.Adapters.HomeEntertainmentSelectedVideoRecyclerAdapter;
...
public class HomeEntertainmentSelectedVideoShowFragment extends Fragment {
    Activity mActivity;
    View view;
    ...
    View commentView;
    private String titleDescription = "Here is Share Content";
    HomeEntertainmentSelectedVideoRecyclerAdapter homePopularRecyclerAdapter;
        ...
        networkUtils.postDataVolley(Config.MethodName.getVideos, jsonBody, new VolleyCallback() {
            ...
            public void onSuccessResponse(String result) {
                ...
                try {
                    ...
                    try {
                        List<EntertainmentSelectedVideoModel> entertainmentSelectedVideoModelList = ParcingUtils.parseHomeSelectedVideoModelList(jsonArray);
                        ...
                        */
                        ...
                        rvVideos.setItemTransformer(new ScaleTransformer.Builder()
                                ...
                                .build());
                        entertainmentSelectedVideoModelList.get(0).setShow_video(1);
                        homePopularRecyclerAdapter= new HomeEntertainmentSelectedVideoRecyclerAdapter(mActivity, entertainmentSelectedVideoModelList, HomeEntertainmentSelectedVideoShowFragment.this);
    ...
    public void shareVideo(String title,String path) {
