...
public class HomePopularRecyclerAdapter extends RecyclerView.Adapter<HomePopularRecyclerAdapter.CatalogListViewHolder> {
    ...
    public HomePopularRecyclerAdapter(Activity activity, List<HomePopularModel> homePopularModelList, PopularFragment popularFragment) {
        ...
        animFadein = AnimationUtils.loadAnimation(activity,
                R.anim.fade_in);
        animslideup = AnimationUtils.loadAnimation(activity,
                R.anim.slide_up);
    }
    ...
    /*    RotateAnimation r = new RotateAnimation(0, 360,
        ...
        holder.ivComment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (commentStatus.equals("1")) {
                    popularFragment.getCommentList(videoId);
                } else {
                    popularFragment.showNoCommentDialog();
                }
        ...
        holder.ivLike.setOnLikeListener(new OnLikeListener() {
            ...
            public void liked(LikeButton likeButton) {
                if (!TextUtils.isEmpty(userId)) {
                    ...
                    popularFragment.likeVideoApi(videoId, String.valueOf(pos));
        ...
        holder.ivFollow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!TextUtils.isEmpty(userId)) {
                    Log.wtf("userid", "userid");
                    popularFragment.followApi(userProfileId);
                } else {
                    Log.wtf("userid", "notuserid");
                    activity.startActivity(new Intent(activity, LoginActivity.class));
                }
        ...
        holder.ivShare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!TextUtils.isEmpty(userId)) {
                    ...
                    if (myFile.exists()) {
                        popularFragment.shareVideo("Tamas", myFile.getAbsolutePath());
                        popularFragment.addShareCount(videoId);
                    } else {
                        popularFragment.videoDownload(videoUrl);
                        popularFragment.addShareCount(videoId);
                    }
