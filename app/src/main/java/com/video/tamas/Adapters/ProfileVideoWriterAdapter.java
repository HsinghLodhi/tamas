...
public class ProfileVideoWriterAdapter extends RecyclerView.Adapter<ProfileVideoWriterAdapter.CatalogListViewHolder> {

    private Activity activity;
    private List<ProfileModelClass> profileModelClassList = new ArrayList<>();

    public ProfileVideoWriterAdapter(Activity activity, List<ProfileModelClass> profileModelClassList) {
    ...
    public void onBindViewHolder(final CatalogListViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            ...
            Log.w("adapterPos", String.valueOf(pos));
             PopularFragment dashBoardTradesFragment = new PopularFragment(position,userId,"selfProfile");
